...
import circle_icon from '../../Components/Assests/circle.png'
import cross_icon from '../../Components/Assests/cross.png'
...
const TicTacToe = () => {
    ...
    const won = (winner) => {
        ...
        titleRef.current.innerHTML = `Congratulation: <img src='${winner === "x" ? cross_icon : circle_icon}'> wins`;
    };
    const reset = () => {
        setLock(false);
        setCount(0);
